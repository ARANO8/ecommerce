...
function insert($input)
{
    ...
    $tseg_producto = new Seg_productoModel();
    $var = $tseg_producto->insert($p_nombre, $p_precio, $p_stock, $p_descripcion, $p_estado,$p_idimg, $p_idcategoria);
...
function update($input)
{
    ...
    $p_idcategoria = !empty($input['idcategoria']) ? $input['idcategoria'] : $_POST['idcategoria'];
    $tseg_producto = new Seg_productoModel();
    $var = $tseg_producto->update($p_idproducto, $p_nombre, $p_precio, $p_stock, $p_descripcion, $p_estado,$p_idimg, $p_idcategoria);
