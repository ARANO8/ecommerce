                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <?php foreach ($records as  $row) : ?>
                                            <tr>
                                                <td>
                                                    <a href="<?php echo HTTP_BASE . "/web/seg_tienda/view/" . $row['idproducto']; ?>" class="btn btn-warning btn-sm">Ver</a>
                                                    <a href="<?php echo HTTP_BASE . "/web/seg_tienda/edit/" . $row['idproducto']; ?>" class="btn btn-primary btn-sm">Editar</a>
                                                    <a href="<?php echo HTTP_BASE . "/web/seg_tienda/delete/" . $row['idproducto']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                                                </td>
